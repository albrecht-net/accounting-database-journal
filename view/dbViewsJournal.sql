...
AS SELECT
  ...
  period.label AS period,
  classification1.classificationID AS classification1ID,
  classification1.label AS classification1,
  classification2.classificationID AS classification2ID,
  classification2.label AS classification2,
  classification3.classificationID AS classification3ID,
  classification3.label AS classification3,
  j.entryReference,
  j.reconcilation
FROM journal j
